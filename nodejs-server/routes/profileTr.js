...
router.post('/', function (req, res) {
  ...
  uploadTr(req, res, function (err) {
    ...
    child = execSync('cd ../neuraltalk2-master && th eval.lua -model ./model/model_tr_idcoco_wc5_StartCNN.t7_cpu.t7 -image_folder ./vis/imgs/ -num_images 1 -gpuid -1')
